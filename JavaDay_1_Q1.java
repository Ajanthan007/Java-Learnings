...
public class JavaDay_1_Q1 {
    ...
    public static void main(String[] args)
	{
		 ...
		 * a palindrome1. Write a Java Program to find the occurance of the character
		 * 'o' in the following String. Input:
		 * "You have no choice other than following me!" output: Occurance of o is: 6 2.
